...
# dev_scripts/generate_test_for_xmlization_of_classes_with_descendants.py
...
class Test_HasSemantics(unittest.TestCase):
    ...
    def test_over_relationship_element(self) -> None:
        concrete_instance = (
            tests.common_jsonization.load_complete_relationship_element()
        )
    ...
    def test_over_basic_event_element(self) -> None:
        concrete_instance = tests.common_jsonization.load_complete_basic_event_element()
        text = aas_xmlization.to_str(concrete_instance)
        et_concrete = ET.fromstring(text)
    ...
    def test_over_blob(self) -> None:
        concrete_instance = tests.common_jsonization.load_complete_blob()
        text = aas_xmlization.to_str(concrete_instance)
        et_concrete = ET.fromstring(text)
    ...
    def test_over_capability(self) -> None:
        concrete_instance = tests.common_jsonization.load_complete_capability()
        text = aas_xmlization.to_str(concrete_instance)
        et_concrete = ET.fromstring(text)
    ...
    def test_over_entity(self) -> None:
        concrete_instance = tests.common_jsonization.load_complete_entity()
        text = aas_xmlization.to_str(concrete_instance)
        et_concrete = ET.fromstring(text)
    ...
    def test_over_extension(self) -> None:
        concrete_instance = tests.common_jsonization.load_complete_extension()
        text = aas_xmlization.to_str(concrete_instance)
        et_concrete = ET.fromstring(text)
    ...
    def test_over_file(self) -> None:
        concrete_instance = tests.common_jsonization.load_complete_file()
        text = aas_xmlization.to_str(concrete_instance)
        et_concrete = ET.fromstring(text)
    ...
    def test_over_multi_language_property(self) -> None:
        concrete_instance = (
            tests.common_jsonization.load_complete_multi_language_property()
        )
        text = aas_xmlization.to_str(concrete_instance)
        et_concrete = ET.fromstring(text)
    ...
    def test_over_operation(self) -> None:
        concrete_instance = tests.common_jsonization.load_complete_operation()
        text = aas_xmlization.to_str(concrete_instance)
        et_concrete = ET.fromstring(text)
    ...
    def test_over_property(self) -> None:
        concrete_instance = tests.common_jsonization.load_complete_property()
        text = aas_xmlization.to_str(concrete_instance)
        et_concrete = ET.fromstring(text)
    ...
    def test_over_qualifier(self) -> None:
        concrete_instance = tests.common_jsonization.load_complete_qualifier()
        text = aas_xmlization.to_str(concrete_instance)
        et_concrete = ET.fromstring(text)
    ...
    def test_over_range(self) -> None:
        concrete_instance = tests.common_jsonization.load_complete_range()
        text = aas_xmlization.to_str(concrete_instance)
        et_concrete = ET.fromstring(text)
    ...
    def test_over_reference_element(self) -> None:
        concrete_instance = tests.common_jsonization.load_complete_reference_element()
        text = aas_xmlization.to_str(concrete_instance)
        et_concrete = ET.fromstring(text)
    ...
    def test_over_specific_asset_id(self) -> None:
        concrete_instance = tests.common_jsonization.load_complete_specific_asset_id()
        text = aas_xmlization.to_str(concrete_instance)
        et_concrete = ET.fromstring(text)
    ...
    def test_over_submodel(self) -> None:
        concrete_instance = tests.common_jsonization.load_complete_submodel()
        text = aas_xmlization.to_str(concrete_instance)
        et_concrete = ET.fromstring(text)
    ...
    def test_over_submodel_element_collection(self) -> None:
        concrete_instance = (
            tests.common_jsonization.load_complete_submodel_element_collection()
        )
        text = aas_xmlization.to_str(concrete_instance)
        et_concrete = ET.fromstring(text)
    ...
    def test_over_submodel_element_list(self) -> None:
        concrete_instance = (
            tests.common_jsonization.load_complete_submodel_element_list()
        )
        text = aas_xmlization.to_str(concrete_instance)
        et_concrete = ET.fromstring(text)
...
class Test_HasExtensions(unittest.TestCase):
    ...
    def test_over_asset_administration_shell(self) -> None:
        concrete_instance = (
            tests.common_jsonization.load_complete_asset_administration_shell()
        )
        text = aas_xmlization.to_str(concrete_instance)
        et_concrete = ET.fromstring(text)
    ...
    def test_over_concept_description(self) -> None:
        concrete_instance = tests.common_jsonization.load_complete_concept_description()
        text = aas_xmlization.to_str(concrete_instance)
        et_concrete = ET.fromstring(text)
...
class Test_HasDataSpecification(unittest.TestCase):
    ...
    def test_over_administrative_information(self) -> None:
        concrete_instance = (
            tests.common_jsonization.load_complete_administrative_information()
        )
        text = aas_xmlization.to_str(concrete_instance)
        et_concrete = ET.fromstring(text)
...
class Test_DataSpecificationContent(unittest.TestCase):
    ...
    def test_over_data_specification_iec_61360(self) -> None:
        concrete_instance = (
            tests.common_jsonization.load_complete_data_specification_iec_61360()
        )
        text = aas_xmlization.to_str(concrete_instance)
        et_concrete = ET.fromstring(text)
    ...
    def test_over_data_specification_physical_unit(self) -> None:
        concrete_instance = (
