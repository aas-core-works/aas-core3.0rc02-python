...
# dev_scripts/generate_test_for_jsonization_of_enums.py
...
class Test_ModelingKind(unittest.TestCase):
    def test_round_trip(self) -> None:
        jsonable = "Template"

        enum_literal = aas_jsonization.modeling_kind_from_jsonable(jsonable)
...
class Test_LevelType(unittest.TestCase):
    def test_round_trip(self) -> None:
        ...
        enum_literal = aas_jsonization.level_type_from_jsonable(jsonable)
