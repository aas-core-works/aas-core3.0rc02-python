...
# dev_scripts/generate_test_for_jsonization_of_concrete_classes_outside_container.py
...
class Test_LangString(unittest.TestCase):
    def test_round_trip(self) -> None:
        ...
        another_instance = aas_jsonization.lang_string_from_jsonable(jsonable)
...
class Test_DataSpecificationPhysicalUnit(unittest.TestCase):
    def test_round_trip(self) -> None:
        ...
        another_instance = (
            aas_jsonization.data_specification_physical_unit_from_jsonable(jsonable)
        )
