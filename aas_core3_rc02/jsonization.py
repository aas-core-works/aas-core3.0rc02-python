...
class _SetterForExtension:
    ...
    def set_refers_to_from_jsonable(self, jsonable: Jsonable) -> None:
        ...
        :param jsonable: input to be parsed
        """
        self.refers_to = reference_from_jsonable(jsonable)
...
def modeling_kind_from_jsonable(jsonable: Jsonable) -> aas_types.ModelingKind:
    """
    Convert the JSON-able structure :paramref:`jsonable` to a literal of
    :py:class:`.types.ModelingKind`.
    ...
    literal = aas_stringification.modeling_kind_from_str(jsonable)
    if literal is None:
        raise DeserializationException(
            f"Not a valid string representation of "
            f"a literal of ModelingKind: {jsonable}"
        )
...
def administrative_information_from_jsonable(
    ...
    return aas_types.AdministrativeInformation(
        setter.embedded_data_specifications, setter.version, setter.revision
    )
...
class _SetterForAssetAdministrationShell:
    ...
    def set_display_name_from_jsonable(self, jsonable: Jsonable) -> None:
        ...
        items: List[aas_types.LangString] = []
        for i, jsonable_item in enumerate(jsonable):
            try:
                item = lang_string_from_jsonable(jsonable_item)
            except DeserializationException as exception:
                exception.path._prepend(IndexSegment(jsonable, i))
                raise
    ...
    def set_checksum_from_jsonable(self, jsonable: Jsonable) -> None:
        """
        Parse :paramref:`jsonable` as the value of :py:attr:`~checksum`.

        :param jsonable: input to be parsed
        """
        self.checksum = _str_from_jsonable(jsonable)
...
class _SetterForAssetInformation:
    ...
    def set_global_asset_id_from_jsonable(self, jsonable: Jsonable) -> None:
        ...
        :param jsonable: input to be parsed
        """
        self.global_asset_id = reference_from_jsonable(jsonable)
...
def specific_asset_id_from_jsonable(jsonable: Jsonable) -> aas_types.SpecificAssetId:
    ...
    if setter.external_subject_id is None:
        raise DeserializationException(
...
class _SetterForSubmodel:
    ...
    def set_kind_from_jsonable(self, jsonable: Jsonable) -> None:
        ...
        :param jsonable: input to be parsed
        """
        self.kind = modeling_kind_from_jsonable(jsonable)
...
class _SetterForEntity:
    ...
    def set_specific_asset_id_from_jsonable(self, jsonable: Jsonable) -> None:
        """
        Parse :paramref:`jsonable` as the value of :py:attr:`~specific_asset_id`.

        :param jsonable: input to be parsed
        """
        self.specific_asset_id = specific_asset_id_from_jsonable(jsonable)
...
class _SetterForEventPayload:
    ...
    def set_payload_from_jsonable(self, jsonable: Jsonable) -> None:
        ...
        :param jsonable: input to be parsed
        """
        self.payload = _str_from_jsonable(jsonable)
...
def lang_string_from_jsonable(jsonable: Jsonable) -> aas_types.LangString:
    """
    ...
    setter = _SetterForLangString()

    for key, jsonable_value in jsonable.items():
        setter_method = _SETTER_MAP_FOR_LANG_STRING.get(key)
        if setter_method is None:
            raise DeserializationException(f"Unexpected property: {key}")
    ...
    return aas_types.LangString(setter.language, setter.text)
...
def level_type_from_jsonable(jsonable: Jsonable) -> aas_types.LevelType:
    ...
    literal = aas_stringification.level_type_from_str(jsonable)
    if literal is None:
        raise DeserializationException(
            f"Not a valid string representation of "
            f"a literal of LevelType: {jsonable}"
        )
...
class _SetterForDataSpecificationPhysicalUnit:
    """Provide de-serialization-setters for properties."""
    ...
    def set_unit_name_from_jsonable(self, jsonable: Jsonable) -> None:
        """
        Parse :paramref:`jsonable` as the value of :py:attr:`~unit_name`.

        :param jsonable: input to be parsed
        """
        self.unit_name = _str_from_jsonable(jsonable)

    def set_unit_symbol_from_jsonable(self, jsonable: Jsonable) -> None:
        """
        Parse :paramref:`jsonable` as the value of :py:attr:`~unit_symbol`.

        :param jsonable: input to be parsed
        """
        self.unit_symbol = _str_from_jsonable(jsonable)
    ...
    def set_si_notation_from_jsonable(self, jsonable: Jsonable) -> None:
        """
        Parse :paramref:`jsonable` as the value of :py:attr:`~si_notation`.

        :param jsonable: input to be parsed
        """
        self.si_notation = _str_from_jsonable(jsonable)

    def set_si_name_from_jsonable(self, jsonable: Jsonable) -> None:
        """
        Parse :paramref:`jsonable` as the value of :py:attr:`~si_name`.

        :param jsonable: input to be parsed
        """
        self.si_name = _str_from_jsonable(jsonable)

    def set_din_notation_from_jsonable(self, jsonable: Jsonable) -> None:
        """
        Parse :paramref:`jsonable` as the value of :py:attr:`~din_notation`.

        :param jsonable: input to be parsed
        """
        self.din_notation = _str_from_jsonable(jsonable)

    def set_ece_name_from_jsonable(self, jsonable: Jsonable) -> None:
        """
        Parse :paramref:`jsonable` as the value of :py:attr:`~ece_name`.

        :param jsonable: input to be parsed
        """
        self.ece_name = _str_from_jsonable(jsonable)

    def set_ece_code_from_jsonable(self, jsonable: Jsonable) -> None:
        """
        Parse :paramref:`jsonable` as the value of :py:attr:`~ece_code`.

        :param jsonable: input to be parsed
        """
        self.ece_code = _str_from_jsonable(jsonable)

    def set_nist_name_from_jsonable(self, jsonable: Jsonable) -> None:
        """
        Parse :paramref:`jsonable` as the value of :py:attr:`~nist_name`.

        :param jsonable: input to be parsed
        """
        self.nist_name = _str_from_jsonable(jsonable)
    ...
    def set_conversion_factor_from_jsonable(self, jsonable: Jsonable) -> None:
        """
        Parse :paramref:`jsonable` as the value of :py:attr:`~conversion_factor`.

        :param jsonable: input to be parsed
        """
        self.conversion_factor = _str_from_jsonable(jsonable)

    def set_registration_authority_id_from_jsonable(self, jsonable: Jsonable) -> None:
        """
        Parse :paramref:`jsonable` as the value of :py:attr:`~registration_authority_id`.

        :param jsonable: input to be parsed
        """
        self.registration_authority_id = _str_from_jsonable(jsonable)

    def set_supplier_from_jsonable(self, jsonable: Jsonable) -> None:
        """
        Parse :paramref:`jsonable` as the value of :py:attr:`~supplier`.

        :param jsonable: input to be parsed
        """
        self.supplier = _str_from_jsonable(jsonable)


def data_specification_physical_unit_from_jsonable(
    jsonable: Jsonable,
) -> aas_types.DataSpecificationPhysicalUnit:
    """
    Parse an instance of :py:class:`.types.DataSpecificationPhysicalUnit` from the JSON-able
    structure :paramref:`jsonable`.

    :param jsonable: structure to be parsed
    :return: Parsed instance of :py:class:`.types.DataSpecificationPhysicalUnit`
    :raise: :py:class:`DeserializationException` if unexpected :paramref:`jsonable`
    """
    if not isinstance(jsonable, collections.abc.Mapping):
        raise DeserializationException(f"Expected a mapping, but got: {type(jsonable)}")

    setter = _SetterForDataSpecificationPhysicalUnit()

    for key, jsonable_value in jsonable.items():
        setter_method = _SETTER_MAP_FOR_DATA_SPECIFICATION_PHYSICAL_UNIT.get(key)
        if setter_method is None:
            raise DeserializationException(f"Unexpected property: {key}")
    ...
    return aas_types.DataSpecificationPhysicalUnit(
        ...
        setter.nist_name,
        setter.source_of_definition,
        setter.conversion_factor,
        setter.registration_authority_id,
        setter.supplier,
    )
...
_SETTER_MAP_FOR_ASSET_ADMINISTRATION_SHELL: Mapping[
    ...
    "checksum": _SetterForAssetAdministrationShell.set_checksum_from_jsonable,
...
_SETTER_MAP_FOR_SUBMODEL: Mapping[
    ...
    "checksum": _SetterForSubmodel.set_checksum_from_jsonable,
...
_SETTER_MAP_FOR_RELATIONSHIP_ELEMENT: Mapping[
    ...
    "checksum": _SetterForRelationshipElement.set_checksum_from_jsonable,
    "kind": _SetterForRelationshipElement.set_kind_from_jsonable,
...
_SETTER_MAP_FOR_SUBMODEL_ELEMENT_LIST: Mapping[
    ...
    "checksum": _SetterForSubmodelElementList.set_checksum_from_jsonable,
    "kind": _SetterForSubmodelElementList.set_kind_from_jsonable,
...
_SETTER_MAP_FOR_SUBMODEL_ELEMENT_COLLECTION: Mapping[
    ...
    "checksum": _SetterForSubmodelElementCollection.set_checksum_from_jsonable,
    "kind": _SetterForSubmodelElementCollection.set_kind_from_jsonable,
...
_SETTER_MAP_FOR_PROPERTY: Mapping[
    ...
    "checksum": _SetterForProperty.set_checksum_from_jsonable,
    "kind": _SetterForProperty.set_kind_from_jsonable,
...
_SETTER_MAP_FOR_MULTI_LANGUAGE_PROPERTY: Mapping[
    ...
    "checksum": _SetterForMultiLanguageProperty.set_checksum_from_jsonable,
    "kind": _SetterForMultiLanguageProperty.set_kind_from_jsonable,
...
_SETTER_MAP_FOR_RANGE: Mapping[str, Callable[[_SetterForRange, Jsonable], None]] = {
    ...
    "checksum": _SetterForRange.set_checksum_from_jsonable,
    "kind": _SetterForRange.set_kind_from_jsonable,
...
_SETTER_MAP_FOR_REFERENCE_ELEMENT: Mapping[
    ...
    "checksum": _SetterForReferenceElement.set_checksum_from_jsonable,
    "kind": _SetterForReferenceElement.set_kind_from_jsonable,
...
_SETTER_MAP_FOR_BLOB: Mapping[str, Callable[[_SetterForBlob, Jsonable], None]] = {
    ...
    "checksum": _SetterForBlob.set_checksum_from_jsonable,
    "kind": _SetterForBlob.set_kind_from_jsonable,
...
_SETTER_MAP_FOR_FILE: Mapping[str, Callable[[_SetterForFile, Jsonable], None]] = {
    ...
    "checksum": _SetterForFile.set_checksum_from_jsonable,
    "kind": _SetterForFile.set_kind_from_jsonable,
...
_SETTER_MAP_FOR_ANNOTATED_RELATIONSHIP_ELEMENT: Mapping[
    ...
    "checksum": _SetterForAnnotatedRelationshipElement.set_checksum_from_jsonable,
    "kind": _SetterForAnnotatedRelationshipElement.set_kind_from_jsonable,
...
_SETTER_MAP_FOR_ENTITY: Mapping[str, Callable[[_SetterForEntity, Jsonable], None]] = {
    ...
    "checksum": _SetterForEntity.set_checksum_from_jsonable,
    "kind": _SetterForEntity.set_kind_from_jsonable,
    ...
    "specificAssetId": _SetterForEntity.set_specific_asset_id_from_jsonable,
...
_SETTER_MAP_FOR_BASIC_EVENT_ELEMENT: Mapping[
    ...
    "checksum": _SetterForBasicEventElement.set_checksum_from_jsonable,
    "kind": _SetterForBasicEventElement.set_kind_from_jsonable,
...
_SETTER_MAP_FOR_OPERATION: Mapping[
    ...
    "checksum": _SetterForOperation.set_checksum_from_jsonable,
    "kind": _SetterForOperation.set_kind_from_jsonable,
...
_SETTER_MAP_FOR_CAPABILITY: Mapping[
    ...
    "checksum": _SetterForCapability.set_checksum_from_jsonable,
    "kind": _SetterForCapability.set_kind_from_jsonable,
...
_SETTER_MAP_FOR_CONCEPT_DESCRIPTION: Mapping[
    ...
    "checksum": _SetterForConceptDescription.set_checksum_from_jsonable,
...
_SETTER_MAP_FOR_LANG_STRING: Mapping[
    str, Callable[[_SetterForLangString, Jsonable], None]
] = {
    "language": _SetterForLangString.set_language_from_jsonable,
    "text": _SetterForLangString.set_text_from_jsonable,
    "modelType": _SetterForLangString.ignore,
}
...
_SETTER_MAP_FOR_DATA_SPECIFICATION_PHYSICAL_UNIT: Mapping[
    str, Callable[[_SetterForDataSpecificationPhysicalUnit, Jsonable], None]
] = {
    "unitName": _SetterForDataSpecificationPhysicalUnit.set_unit_name_from_jsonable,
    "unitSymbol": _SetterForDataSpecificationPhysicalUnit.set_unit_symbol_from_jsonable,
    "definition": _SetterForDataSpecificationPhysicalUnit.set_definition_from_jsonable,
    "siNotation": _SetterForDataSpecificationPhysicalUnit.set_si_notation_from_jsonable,
    "siName": _SetterForDataSpecificationPhysicalUnit.set_si_name_from_jsonable,
    "dinNotation": _SetterForDataSpecificationPhysicalUnit.set_din_notation_from_jsonable,
    "eceName": _SetterForDataSpecificationPhysicalUnit.set_ece_name_from_jsonable,
    "eceCode": _SetterForDataSpecificationPhysicalUnit.set_ece_code_from_jsonable,
    "nistName": _SetterForDataSpecificationPhysicalUnit.set_nist_name_from_jsonable,
    "sourceOfDefinition": _SetterForDataSpecificationPhysicalUnit.set_source_of_definition_from_jsonable,
    "conversionFactor": _SetterForDataSpecificationPhysicalUnit.set_conversion_factor_from_jsonable,
    "registrationAuthorityId": _SetterForDataSpecificationPhysicalUnit.set_registration_authority_id_from_jsonable,
    "supplier": _SetterForDataSpecificationPhysicalUnit.set_supplier_from_jsonable,
    "modelType": _SetterForDataSpecificationPhysicalUnit.ignore,
}
...
class _Serializer(aas_types.AbstractTransformer[MutableJsonable]):
    ...
    def transform_extension(self, that: aas_types.Extension) -> MutableJsonable:
        ...
        if that.refers_to is not None:
            jsonable["refersTo"] = self.transform(that.refers_to)
    ...
    def transform_asset_information(
        ...
        if that.global_asset_id is not None:
            jsonable["globalAssetId"] = self.transform(that.global_asset_id)
    ...
    def transform_entity(self, that: aas_types.Entity) -> MutableJsonable:
        ...
        if that.specific_asset_id is not None:
            jsonable["specificAssetId"] = self.transform(that.specific_asset_id)
    ...
    # noinspection PyMethodMayBeStatic
    def transform_lang_string(self, that: aas_types.LangString) -> MutableJsonable:
        """Serialize :paramref:`that` to a JSON-able representation."""
        jsonable: MutableMapping[str, MutableJsonable] = dict()
    ...
    def transform_data_specification_physical_unit(
        ...
        jsonable["unitName"] = that.unit_name

        jsonable["unitSymbol"] = that.unit_symbol

        jsonable["definition"] = [self.transform(item) for item in that.definition]

        if that.si_notation is not None:
            jsonable["siNotation"] = that.si_notation

        if that.si_name is not None:
            jsonable["siName"] = that.si_name

        if that.din_notation is not None:
            jsonable["dinNotation"] = that.din_notation

        if that.ece_name is not None:
            jsonable["eceName"] = that.ece_name

        if that.ece_code is not None:
            jsonable["eceCode"] = that.ece_code

        if that.nist_name is not None:
            jsonable["nistName"] = that.nist_name

        if that.source_of_definition is not None:
            jsonable["sourceOfDefinition"] = that.source_of_definition

        if that.conversion_factor is not None:
            jsonable["conversionFactor"] = that.conversion_factor

        if that.registration_authority_id is not None:
            jsonable["registrationAuthorityId"] = that.registration_authority_id
