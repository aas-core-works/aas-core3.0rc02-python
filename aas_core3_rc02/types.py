...
class Referable(HasExtensions):
    ...
    def over_display_name_or_empty(self) -> Iterator["LangString"]:
        """Yield from :py:attr:`.display_name` if set."""
        if self.display_name is not None:
            yield from self.display_name

    def over_description_or_empty(self) -> Iterator["LangString"]:
...
class Identifiable(Referable):
    ...
    def __init__(
        ...
        """Initialize with the given values."""
        Referable.__init__(
            self, extensions, category, id_short, display_name, description, checksum
        )
        self.id = id
...
class SubmodelElement(
    Referable, HasKind, HasSemantics, Qualifiable, HasDataSpecification
):
    """
...
class MultiLanguageProperty(DataElement):
    ...
    def over_value_or_empty(self) -> Iterator["LangString"]:
        """Yield from :py:attr:`.value` if set."""
        if self.value is not None:
            yield from self.value
...
class LangString(Class):
    ...
    def transform_with_context(
        ...
        Dispatch the :paramref:`transformer` on this instance in :paramref:`context`.
        """
        return transformer.transform_lang_string_with_context(self, context)
...
class DataSpecificationIEC61360(DataSpecificationContent):
    ...
    def over_short_name_or_empty(self) -> Iterator["LangString"]:
        """Yield from :py:attr:`.short_name` if set."""
        if self.short_name is not None:
            yield from self.short_name

    def over_definition_or_empty(self) -> Iterator["LangString"]:
...
class AbstractVisitor:
    ...
    @abc.abstractmethod
    def visit_lang_string(self, that: LangString) -> None:
        """Visit :paramref:`that`."""
        raise NotImplementedError()
    ...
    def visit_data_specification_physical_unit(
        self, that: DataSpecificationPhysicalUnit
    ) -> None:
        """Visit :paramref:`that`."""
        raise NotImplementedError()
...
class AbstractVisitorWithContext(Generic[ContextT]):
    ...
    def visit_lang_string_with_context(
        self, that: LangString, context: ContextT
    ) -> None:
        """Visit :paramref:`that` in :paramref:`context`."""
        raise NotImplementedError()
    ...
    def visit_data_specification_physical_unit_with_context(
        self, that: DataSpecificationPhysicalUnit, context: ContextT
    ) -> None:
        """Visit :paramref:`that` in :paramref:`context`."""
        raise NotImplementedError()
...
class AbstractTransformer(Generic[T]):
    ...
    @abc.abstractmethod
    def transform_lang_string(self, that: LangString) -> T:
        """Transform :paramref:`that`."""
        raise NotImplementedError()
