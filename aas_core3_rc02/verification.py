...
def is_xs_date_time_stamp_utc(value: str) -> bool:
    """
...
def verify_non_empty_string(that: str) -> Iterator[Error]:
...
def verify_date_time_stamp_utc(that: str) -> Iterator[Error]:
    """Verify the constraints of :paramref:`that`."""
...
def verify_id_short(that: str) -> Iterator[Error]:
    """Verify the constraints of :paramref:`that`."""
    if not (len(that) <= 128):
        yield Error(
