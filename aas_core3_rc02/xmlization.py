...
For writing, use the function :py:func:`aas_core3_rc02.xmlization.write` which
...
def lang_string_from_iterparse(
    iterator: Iterator[Tuple[str, Element]]
) -> aas_types.LangString:
    """
    Read an instance of :py:class:`.types.LangString` from
    the :paramref:`iterator`.
    ...
    :raise: :py:class:`DeserializationException` if unexpected input
    :return:
        Instance of :py:class:`.types.LangString` read from
        :paramref:`iterator`
    """
    next_event_element = next(iterator, None)
    if next_event_element is None:
        raise DeserializationException(
            # fmt: off
            "Expected the start element for LangString, "
            "but got the end-of-input"
            # fmt: on
        )
    ...
    if next_event != "start":
        raise DeserializationException(
            f"Expected the start element for LangString, "
            f"but got event {next_event!r} and element {next_element.tag!r}"
        )

    try:
        return _read_lang_string_as_element(next_element, iterator)
    except DeserializationException as exception:
        exception.path._prepend(ElementSegment(next_element))
        raise exception


def lang_string_from_stream(
    stream: TextIO, has_iterparse: HasIterparse = xml.etree.ElementTree
) -> aas_types.LangString:
    """
    Read an instance of :py:class:`.types.LangString` from
    ...
    :param stream:
        representing an instance of
        :py:class:`.types.LangString` in XML
    :param has_iterparse:
        Module containing ``iterparse`` function.
    ...
    """
    iterator = has_iterparse.iterparse(stream, ["start", "end"])
    return lang_string_from_iterparse(_with_elements_cleared_after_yield(iterator))


def lang_string_from_file(
    path: PathLike, has_iterparse: HasIterparse = xml.etree.ElementTree
) -> aas_types.LangString:
    """
    Read an instance of :py:class:`.types.LangString` from
...
def data_specification_physical_unit_from_iterparse(
    iterator: Iterator[Tuple[str, Element]]
) -> aas_types.DataSpecificationPhysicalUnit:
    """
    Read an instance of :py:class:`.types.DataSpecificationPhysicalUnit` from
    the :paramref:`iterator`.
    ...
    :raise: :py:class:`DeserializationException` if unexpected input
    :return:
        Instance of :py:class:`.types.DataSpecificationPhysicalUnit` read from
        :paramref:`iterator`
    """
    next_event_element = next(iterator, None)
    if next_event_element is None:
        raise DeserializationException(
            # fmt: off
            "Expected the start element for DataSpecificationPhysicalUnit, "
            "but got the end-of-input"
            # fmt: on
        )
    ...
    if next_event != "start":
        raise DeserializationException(
            f"Expected the start element for DataSpecificationPhysicalUnit, "
            f"but got event {next_event!r} and element {next_element.tag!r}"
        )

    try:
        return _read_data_specification_physical_unit_as_element(next_element, iterator)
    except DeserializationException as exception:
        exception.path._prepend(ElementSegment(next_element))
        raise exception


def data_specification_physical_unit_from_stream(
    stream: TextIO, has_iterparse: HasIterparse = xml.etree.ElementTree
) -> aas_types.DataSpecificationPhysicalUnit:
    """
    Read an instance of :py:class:`.types.DataSpecificationPhysicalUnit` from
    ...
    :param stream:
        representing an instance of
        :py:class:`.types.DataSpecificationPhysicalUnit` in XML
    :param has_iterparse:
        Module containing ``iterparse`` function.
    ...
    """
    iterator = has_iterparse.iterparse(stream, ["start", "end"])
    return data_specification_physical_unit_from_iterparse(
        _with_elements_cleared_after_yield(iterator)
    )


def data_specification_physical_unit_from_file(
    path: PathLike, has_iterparse: HasIterparse = xml.etree.ElementTree
) -> aas_types.DataSpecificationPhysicalUnit:
    """
    Read an instance of :py:class:`.types.DataSpecificationPhysicalUnit` from
...
def data_specification_physical_unit_from_str(
    text: str, has_iterparse: HasIterparse = xml.etree.ElementTree
) -> aas_types.DataSpecificationPhysicalUnit:
    """
    Read an instance of :py:class:`.types.DataSpecificationPhysicalUnit` from
...
class _ReaderAndSetterForExtension:
    ...
    def read_and_set_refers_to(
        ...
        """
        self.refers_to = _read_reference_as_sequence(element, iterator)
...
def _read_modeling_kind_from_element_text(
    element: Element, iterator: Iterator[Tuple[str, Element]]
) -> aas_types.ModelingKind:
    """
    Parse the text of :paramref:`element` as a literal of
    :py:class:`.types.ModelingKind`, and read the corresponding
    ...
    literal = aas_stringification.modeling_kind_from_str(text)
    if literal is None:
        raise DeserializationException(
            f"Not a valid string representation of "
            f"a literal of ModelingKind: {text}"
        )
...
class _ReaderAndSetterForAssetAdministrationShell:
    ...
    def __init__(self) -> None:
        ...
        self.display_name: Optional[List[aas_types.LangString]] = None
        self.description: Optional[List[aas_types.LangString]] = None
    ...
    def read_and_set_display_name(
        ...
        result: List[aas_types.LangString] = []
        ...
        while True:
            ...
            try:
                item = _read_lang_string_as_element(next_element, iterator)
            except DeserializationException as exception:
                exception.path._prepend(IndexSegment(next_element, item_i))
                raise
    ...
    def read_and_set_checksum(
        self, element: Element, iterator: Iterator[Tuple[str, Element]]
    ) -> None:
        """
        Read :paramref:`element` as the property
        :py:attr:`.types.AssetAdministrationShell.checksum` and set it.
        """
        self.checksum = _read_str_from_element_text(element, iterator)
...
class _ReaderAndSetterForAssetInformation:
    ...
    def __init__(self) -> None:
        ...
        self.global_asset_id: Optional[aas_types.Reference] = None
    ...
    def read_and_set_global_asset_id(
        ...
        """
        self.global_asset_id = _read_reference_as_sequence(element, iterator)
...
def _read_specific_asset_id_as_sequence(
    ...
    if reader_and_setter.external_subject_id is None:
        raise DeserializationException(
...
class _ReaderAndSetterForSubmodel:
    ...
    def __init__(self) -> None:
        ...
        self.administration: Optional[aas_types.AdministrativeInformation] = None
        self.id: Optional[str] = None
        self.kind: Optional[aas_types.ModelingKind] = None
        self.semantic_id: Optional[aas_types.Reference] = None
        self.supplemental_semantic_ids: Optional[List[aas_types.Reference]] = None
    ...
    def read_and_set_checksum(
        ...
        """
        Read :paramref:`element` as the property
        :py:attr:`.types.Submodel.checksum` and set it.
        """
        self.checksum = _read_str_from_element_text(element, iterator)
    ...
    def read_and_set_kind(
        ...
        """
        self.kind = _read_modeling_kind_from_element_text(element, iterator)
...
class _ReaderAndSetterForRelationshipElement:
    ...
    def read_and_set_checksum(
        ...
        """
        Read :paramref:`element` as the property
        :py:attr:`.types.RelationshipElement.checksum` and set it.
        """
        self.checksum = _read_str_from_element_text(element, iterator)
    ...
    def read_and_set_kind(
        ...
        """
        Read :paramref:`element` as the property
        :py:attr:`.types.RelationshipElement.kind` and set it.
        """
        self.kind = _read_modeling_kind_from_element_text(element, iterator)
...
class _ReaderAndSetterForSubmodelElementList:
    ...
    def read_and_set_checksum(
        ...
        """
        Read :paramref:`element` as the property
        :py:attr:`.types.SubmodelElementList.checksum` and set it.
        """
        self.checksum = _read_str_from_element_text(element, iterator)
    ...
    def read_and_set_kind(
        ...
        """
        Read :paramref:`element` as the property
        :py:attr:`.types.SubmodelElementList.kind` and set it.
        """
        self.kind = _read_modeling_kind_from_element_text(element, iterator)
...
class _ReaderAndSetterForSubmodelElementCollection:
    ...
    def read_and_set_checksum(
        ...
        """
        Read :paramref:`element` as the property
        :py:attr:`.types.SubmodelElementCollection.checksum` and set it.
        """
        self.checksum = _read_str_from_element_text(element, iterator)
    ...
    def read_and_set_kind(
        ...
        """
        Read :paramref:`element` as the property
        :py:attr:`.types.SubmodelElementCollection.kind` and set it.
        """
        self.kind = _read_modeling_kind_from_element_text(element, iterator)
...
class _ReaderAndSetterForProperty:
    ...
    def read_and_set_checksum(
        ...
        """
        Read :paramref:`element` as the property
        :py:attr:`.types.Property.checksum` and set it.
        """
        self.checksum = _read_str_from_element_text(element, iterator)
    ...
    def read_and_set_kind(
        ...
        """
        Read :paramref:`element` as the property
        :py:attr:`.types.Property.kind` and set it.
        """
        self.kind = _read_modeling_kind_from_element_text(element, iterator)
...
class _ReaderAndSetterForMultiLanguageProperty:
    ...
    def __init__(self) -> None:
        ...
        self.value: Optional[List[aas_types.LangString]] = None
        self.value_id: Optional[aas_types.Reference] = None
    ...
    def read_and_set_checksum(
        ...
        """
        Read :paramref:`element` as the property
        :py:attr:`.types.MultiLanguageProperty.checksum` and set it.
        """
        self.checksum = _read_str_from_element_text(element, iterator)
    ...
    def read_and_set_kind(
        ...
        """
        Read :paramref:`element` as the property
        :py:attr:`.types.MultiLanguageProperty.kind` and set it.
        """
        self.kind = _read_modeling_kind_from_element_text(element, iterator)
...
class _ReaderAndSetterForRange:
    ...
    def read_and_set_checksum(
        ...
        """
        Read :paramref:`element` as the property
        :py:attr:`.types.Range.checksum` and set it.
        """
        self.checksum = _read_str_from_element_text(element, iterator)
    ...
    def read_and_set_kind(
        ...
        """
        Read :paramref:`element` as the property
        :py:attr:`.types.Range.kind` and set it.
        """
        self.kind = _read_modeling_kind_from_element_text(element, iterator)
...
class _ReaderAndSetterForReferenceElement:
    ...
    def read_and_set_checksum(
        ...
        """
        Read :paramref:`element` as the property
        :py:attr:`.types.ReferenceElement.checksum` and set it.
        """
        self.checksum = _read_str_from_element_text(element, iterator)
    ...
    def read_and_set_kind(
        ...
        """
        Read :paramref:`element` as the property
        :py:attr:`.types.ReferenceElement.kind` and set it.
        """
        self.kind = _read_modeling_kind_from_element_text(element, iterator)
...
class _ReaderAndSetterForBlob:
    ...
    def read_and_set_checksum(
        ...
        """
        Read :paramref:`element` as the property
        :py:attr:`.types.Blob.checksum` and set it.
        """
        self.checksum = _read_str_from_element_text(element, iterator)
    ...
    def read_and_set_kind(
        ...
        """
        Read :paramref:`element` as the property
        :py:attr:`.types.Blob.kind` and set it.
        """
        self.kind = _read_modeling_kind_from_element_text(element, iterator)
...
class _ReaderAndSetterForFile:
    ...
    def read_and_set_checksum(
        ...
        """
        Read :paramref:`element` as the property
        :py:attr:`.types.File.checksum` and set it.
        """
        self.checksum = _read_str_from_element_text(element, iterator)
    ...
    def read_and_set_kind(
        ...
        """
        Read :paramref:`element` as the property
        :py:attr:`.types.File.kind` and set it.
        """
        self.kind = _read_modeling_kind_from_element_text(element, iterator)
...
class _ReaderAndSetterForAnnotatedRelationshipElement:
    ...
    def read_and_set_checksum(
        ...
        """
        Read :paramref:`element` as the property
        :py:attr:`.types.AnnotatedRelationshipElement.checksum` and set it.
        """
        self.checksum = _read_str_from_element_text(element, iterator)
    ...
    def read_and_set_kind(
        ...
        """
        Read :paramref:`element` as the property
        :py:attr:`.types.AnnotatedRelationshipElement.kind` and set it.
        """
        self.kind = _read_modeling_kind_from_element_text(element, iterator)
...
class _ReaderAndSetterForEntity:
    ...
    def __init__(self) -> None:
        ...
        self.global_asset_id: Optional[aas_types.Reference] = None
        self.specific_asset_id: Optional[aas_types.SpecificAssetId] = None
    ...
    def read_and_set_checksum(
        ...
        """
        Read :paramref:`element` as the property
        :py:attr:`.types.Entity.checksum` and set it.
        """
        self.checksum = _read_str_from_element_text(element, iterator)
    ...
    def read_and_set_kind(
        ...
        """
        Read :paramref:`element` as the property
        :py:attr:`.types.Entity.kind` and set it.
        """
        self.kind = _read_modeling_kind_from_element_text(element, iterator)
    ...
    def read_and_set_specific_asset_id(
        self, element: Element, iterator: Iterator[Tuple[str, Element]]
    ) -> None:
        """
        Read :paramref:`element` as the property
        :py:attr:`.types.Entity.specific_asset_id` and set it.
        """
        self.specific_asset_id = _read_specific_asset_id_as_sequence(element, iterator)
...
def _read_entity_as_sequence(
    ...
    return aas_types.Entity(
        ...
        reader_and_setter.global_asset_id,
        reader_and_setter.specific_asset_id,
    )
...
class _ReaderAndSetterForEventPayload:
    ...
    def read_and_set_payload(
        ...
        """
        self.payload = _read_str_from_element_text(element, iterator)
...
class _ReaderAndSetterForBasicEventElement:
    ...
    def read_and_set_checksum(
        ...
        """
        Read :paramref:`element` as the property
        :py:attr:`.types.BasicEventElement.checksum` and set it.
        """
        self.checksum = _read_str_from_element_text(element, iterator)
    ...
    def read_and_set_kind(
        ...
        """
        Read :paramref:`element` as the property
        :py:attr:`.types.BasicEventElement.kind` and set it.
        """
        self.kind = _read_modeling_kind_from_element_text(element, iterator)
...
class _ReaderAndSetterForOperation:
    ...
    def read_and_set_checksum(
        ...
        """
        Read :paramref:`element` as the property
        :py:attr:`.types.Operation.checksum` and set it.
        """
        self.checksum = _read_str_from_element_text(element, iterator)
    ...
    def read_and_set_kind(
        ...
        """
        Read :paramref:`element` as the property
        :py:attr:`.types.Operation.kind` and set it.
        """
        self.kind = _read_modeling_kind_from_element_text(element, iterator)
...
class _ReaderAndSetterForCapability:
    ...
    def read_and_set_checksum(
        ...
        """
        Read :paramref:`element` as the property
        :py:attr:`.types.Capability.checksum` and set it.
        """
        self.checksum = _read_str_from_element_text(element, iterator)
    ...
    def read_and_set_kind(
        ...
        """
        Read :paramref:`element` as the property
        :py:attr:`.types.Capability.kind` and set it.
        """
        self.kind = _read_modeling_kind_from_element_text(element, iterator)
...
class _ReaderAndSetterForConceptDescription:
    ...
    def read_and_set_checksum(
        ...
        """
        Read :paramref:`element` as the property
        :py:attr:`.types.ConceptDescription.checksum` and set it.
        """
        self.checksum = _read_str_from_element_text(element, iterator)
...
class _ReaderAndSetterForLangString:
    """
    Provide a buffer for reading and setting the properties for the class
    :py:class:`LangString`.

    The properties correspond to the constructor arguments of
    :py:class:`LangString`. We use this buffer to facilitate dispatching when
    parsing the properties in a streaming fashion.
    """
    ...
    def read_and_set_language(
        ...
        """
        Read :paramref:`element` as the property
        :py:attr:`.types.LangString.language` and set it.
        """
    ...
    def read_and_set_text(
        ...
        """
        Read :paramref:`element` as the property
        :py:attr:`.types.LangString.text` and set it.
        """
        self.text = _read_str_from_element_text(element, iterator)


def _read_lang_string_as_sequence(
    element: Element, iterator: Iterator[Tuple[str, Element]]
) -> aas_types.LangString:
    """
    Read an instance of :py:class:`.types.LangString`
    as a sequence of XML-encoded properties.
    ...
    reader_and_setter = _ReaderAndSetterForLangString()
    ...
    while True:
        ...
        read_and_set_method = _READ_AND_SET_DISPATCH_FOR_LANG_STRING.get(
            tag_wo_ns, None
        )
        if read_and_set_method is None:
            an_exception = DeserializationException(
    ...
    return aas_types.LangString(reader_and_setter.language, reader_and_setter.text)


def _read_lang_string_as_element(
    element: Element, iterator: Iterator[Tuple[str, Element]]
) -> aas_types.LangString:
    """
    Read an instance of :py:class:`.types.LangString` from
    ...
    if tag_wo_ns != "langString":
        raise DeserializationException(
            f"Expected the element with the tag 'langString', "
            f"but got tag: {tag_wo_ns}"
        )

    return _read_lang_string_as_sequence(element, iterator)
...
def _read_level_type_from_element_text(
    element: Element, iterator: Iterator[Tuple[str, Element]]
) -> aas_types.LevelType:
    """
    Parse the text of :paramref:`element` as a literal of
    :py:class:`.types.LevelType`, and read the corresponding
    end element from :paramref:`iterator`.
    ...
    literal = aas_stringification.level_type_from_str(text)
    if literal is None:
        raise DeserializationException(
            f"Not a valid string representation of " f"a literal of LevelType: {text}"
        )
...
class _ReaderAndSetterForDataSpecificationIEC61360:
    ...
    def __init__(self) -> None:
        """Initialize with all the properties unset."""
        self.preferred_name: Optional[List[aas_types.LangString]] = None
        self.short_name: Optional[List[aas_types.LangString]] = None
        ...
        self.definition: Optional[List[aas_types.LangString]] = None
    ...
    def read_and_set_level_type(
        ...
        """
        self.level_type = _read_level_type_from_element_text(element, iterator)
...
class _ReaderAndSetterForDataSpecificationPhysicalUnit:
    """
    Provide a buffer for reading and setting the properties for the class
    :py:class:`DataSpecificationPhysicalUnit`.

    The properties correspond to the constructor arguments of
    :py:class:`DataSpecificationPhysicalUnit`. We use this buffer to facilitate dispatching when
    parsing the properties in a streaming fashion.
    """
    ...
    def __init__(self) -> None:
        ...
        self.unit_symbol: Optional[str] = None
        self.definition: Optional[List[aas_types.LangString]] = None
        self.si_notation: Optional[str] = None
        self.si_name: Optional[str] = None
        self.din_notation: Optional[str] = None
        self.ece_name: Optional[str] = None
        self.ece_code: Optional[str] = None
        self.nist_name: Optional[str] = None
        self.source_of_definition: Optional[str] = None
        self.conversion_factor: Optional[str] = None
        self.registration_authority_id: Optional[str] = None
        self.supplier: Optional[str] = None

    def read_and_set_unit_name(
        self, element: Element, iterator: Iterator[Tuple[str, Element]]
    ) -> None:
        """
        Read :paramref:`element` as the property
        :py:attr:`.types.DataSpecificationPhysicalUnit.unit_name` and set it.
        """
        self.unit_name = _read_str_from_element_text(element, iterator)

    def read_and_set_unit_symbol(
        self, element: Element, iterator: Iterator[Tuple[str, Element]]
    ) -> None:
        """
        Read :paramref:`element` as the property
        :py:attr:`.types.DataSpecificationPhysicalUnit.unit_symbol` and set it.
        """
        self.unit_symbol = _read_str_from_element_text(element, iterator)
    ...
    def read_and_set_definition(
        ...
        """
        Read :paramref:`element` as the property
        :py:attr:`.types.DataSpecificationPhysicalUnit.definition` and set it.
        """
        if element.text is not None and len(element.text.strip()) != 0:
            raise DeserializationException(
                f"Expected only item elements and whitespace text, "
    ...
    def read_and_set_si_notation(
        self, element: Element, iterator: Iterator[Tuple[str, Element]]
    ) -> None:
        """
        Read :paramref:`element` as the property
        :py:attr:`.types.DataSpecificationPhysicalUnit.si_notation` and set it.
        """
        self.si_notation = _read_str_from_element_text(element, iterator)

    def read_and_set_si_name(
        self, element: Element, iterator: Iterator[Tuple[str, Element]]
    ) -> None:
        """
        Read :paramref:`element` as the property
        :py:attr:`.types.DataSpecificationPhysicalUnit.si_name` and set it.
        """
        self.si_name = _read_str_from_element_text(element, iterator)

    def read_and_set_din_notation(
        self, element: Element, iterator: Iterator[Tuple[str, Element]]
    ) -> None:
        """
        Read :paramref:`element` as the property
        :py:attr:`.types.DataSpecificationPhysicalUnit.din_notation` and set it.
        """
        self.din_notation = _read_str_from_element_text(element, iterator)

    def read_and_set_ece_name(
        self, element: Element, iterator: Iterator[Tuple[str, Element]]
    ) -> None:
        """
        Read :paramref:`element` as the property
        :py:attr:`.types.DataSpecificationPhysicalUnit.ece_name` and set it.
        """
        self.ece_name = _read_str_from_element_text(element, iterator)

    def read_and_set_ece_code(
        self, element: Element, iterator: Iterator[Tuple[str, Element]]
    ) -> None:
        """
        Read :paramref:`element` as the property
        :py:attr:`.types.DataSpecificationPhysicalUnit.ece_code` and set it.
        """
        self.ece_code = _read_str_from_element_text(element, iterator)

    def read_and_set_nist_name(
        self, element: Element, iterator: Iterator[Tuple[str, Element]]
    ) -> None:
        """
        Read :paramref:`element` as the property
        :py:attr:`.types.DataSpecificationPhysicalUnit.nist_name` and set it.
        """
        self.nist_name = _read_str_from_element_text(element, iterator)
    ...
    def read_and_set_source_of_definition(
        ...
        """
        Read :paramref:`element` as the property
        :py:attr:`.types.DataSpecificationPhysicalUnit.source_of_definition` and set it.
        """
        self.source_of_definition = _read_str_from_element_text(element, iterator)

    def read_and_set_conversion_factor(
        self, element: Element, iterator: Iterator[Tuple[str, Element]]
    ) -> None:
        """
        Read :paramref:`element` as the property
        :py:attr:`.types.DataSpecificationPhysicalUnit.conversion_factor` and set it.
        """
        self.conversion_factor = _read_str_from_element_text(element, iterator)

    def read_and_set_registration_authority_id(
        self, element: Element, iterator: Iterator[Tuple[str, Element]]
    ) -> None:
        """
        Read :paramref:`element` as the property
        :py:attr:`.types.DataSpecificationPhysicalUnit.registration_authority_id` and set it.
        """
        self.registration_authority_id = _read_str_from_element_text(element, iterator)

    def read_and_set_supplier(
        self, element: Element, iterator: Iterator[Tuple[str, Element]]
    ) -> None:
        """
        Read :paramref:`element` as the property
        :py:attr:`.types.DataSpecificationPhysicalUnit.supplier` and set it.
        """
        self.supplier = _read_str_from_element_text(element, iterator)


def _read_data_specification_physical_unit_as_sequence(
    element: Element, iterator: Iterator[Tuple[str, Element]]
) -> aas_types.DataSpecificationPhysicalUnit:
    """
    Read an instance of :py:class:`.types.DataSpecificationPhysicalUnit`
    as a sequence of XML-encoded properties.
    ...
    reader_and_setter = _ReaderAndSetterForDataSpecificationPhysicalUnit()
    ...
    while True:
        ...
        read_and_set_method = (
            _READ_AND_SET_DISPATCH_FOR_DATA_SPECIFICATION_PHYSICAL_UNIT.get(
                tag_wo_ns, None
            )
        )
        if read_and_set_method is None:
    ...
    if reader_and_setter.unit_name is None:
        raise DeserializationException("The required property 'unitName' is missing")

    if reader_and_setter.unit_symbol is None:
        raise DeserializationException("The required property 'unitSymbol' is missing")

    if reader_and_setter.definition is None:
        raise DeserializationException("The required property 'definition' is missing")

    return aas_types.DataSpecificationPhysicalUnit(
        reader_and_setter.unit_name,
        reader_and_setter.unit_symbol,
        reader_and_setter.definition,
        reader_and_setter.si_notation,
        reader_and_setter.si_name,
        reader_and_setter.din_notation,
        reader_and_setter.ece_name,
        reader_and_setter.ece_code,
        reader_and_setter.nist_name,
        reader_and_setter.source_of_definition,
        reader_and_setter.conversion_factor,
        reader_and_setter.registration_authority_id,
        reader_and_setter.supplier,
    )


def _read_data_specification_physical_unit_as_element(
    element: Element, iterator: Iterator[Tuple[str, Element]]
) -> aas_types.DataSpecificationPhysicalUnit:
    """
    Read an instance of :py:class:`.types.DataSpecificationPhysicalUnit` from
    ...
    if tag_wo_ns != "dataSpecificationPhysicalUnit":
        raise DeserializationException(
            f"Expected the element with the tag 'dataSpecificationPhysicalUnit', "
            f"but got tag: {tag_wo_ns}"
        )

    return _read_data_specification_physical_unit_as_sequence(element, iterator)
...
_READ_AND_SET_DISPATCH_FOR_ASSET_ADMINISTRATION_SHELL: Mapping[
    ...
    "checksum": _ReaderAndSetterForAssetAdministrationShell.read_and_set_checksum,
...
_READ_AND_SET_DISPATCH_FOR_SUBMODEL: Mapping[
    ...
    "checksum": _ReaderAndSetterForSubmodel.read_and_set_checksum,
...
_READ_AND_SET_DISPATCH_FOR_RELATIONSHIP_ELEMENT: Mapping[
    ...
    "checksum": _ReaderAndSetterForRelationshipElement.read_and_set_checksum,
    "kind": _ReaderAndSetterForRelationshipElement.read_and_set_kind,
...
_READ_AND_SET_DISPATCH_FOR_SUBMODEL_ELEMENT_LIST: Mapping[
    ...
    "checksum": _ReaderAndSetterForSubmodelElementList.read_and_set_checksum,
    "kind": _ReaderAndSetterForSubmodelElementList.read_and_set_kind,
...
_READ_AND_SET_DISPATCH_FOR_SUBMODEL_ELEMENT_COLLECTION: Mapping[
    ...
    "checksum": _ReaderAndSetterForSubmodelElementCollection.read_and_set_checksum,
    "kind": _ReaderAndSetterForSubmodelElementCollection.read_and_set_kind,
...
_READ_AND_SET_DISPATCH_FOR_PROPERTY: Mapping[
    ...
    "checksum": _ReaderAndSetterForProperty.read_and_set_checksum,
    "kind": _ReaderAndSetterForProperty.read_and_set_kind,
...
_READ_AND_SET_DISPATCH_FOR_MULTI_LANGUAGE_PROPERTY: Mapping[
    ...
    "checksum": _ReaderAndSetterForMultiLanguageProperty.read_and_set_checksum,
    "kind": _ReaderAndSetterForMultiLanguageProperty.read_and_set_kind,
...
_READ_AND_SET_DISPATCH_FOR_RANGE: Mapping[
    ...
    "checksum": _ReaderAndSetterForRange.read_and_set_checksum,
    "kind": _ReaderAndSetterForRange.read_and_set_kind,
...
_READ_AND_SET_DISPATCH_FOR_REFERENCE_ELEMENT: Mapping[
    ...
    "checksum": _ReaderAndSetterForReferenceElement.read_and_set_checksum,
    "kind": _ReaderAndSetterForReferenceElement.read_and_set_kind,
...
_READ_AND_SET_DISPATCH_FOR_BLOB: Mapping[
    ...
    "checksum": _ReaderAndSetterForBlob.read_and_set_checksum,
    "kind": _ReaderAndSetterForBlob.read_and_set_kind,
...
_READ_AND_SET_DISPATCH_FOR_FILE: Mapping[
    ...
    "checksum": _ReaderAndSetterForFile.read_and_set_checksum,
    "kind": _ReaderAndSetterForFile.read_and_set_kind,
...
_READ_AND_SET_DISPATCH_FOR_ANNOTATED_RELATIONSHIP_ELEMENT: Mapping[
    ...
    "checksum": _ReaderAndSetterForAnnotatedRelationshipElement.read_and_set_checksum,
    "kind": _ReaderAndSetterForAnnotatedRelationshipElement.read_and_set_kind,
...
_READ_AND_SET_DISPATCH_FOR_ENTITY: Mapping[
    ...
    "checksum": _ReaderAndSetterForEntity.read_and_set_checksum,
    "kind": _ReaderAndSetterForEntity.read_and_set_kind,
    ...
    "specificAssetId": _ReaderAndSetterForEntity.read_and_set_specific_asset_id,
}
...
_READ_AND_SET_DISPATCH_FOR_BASIC_EVENT_ELEMENT: Mapping[
    ...
    "checksum": _ReaderAndSetterForBasicEventElement.read_and_set_checksum,
    "kind": _ReaderAndSetterForBasicEventElement.read_and_set_kind,
...
_READ_AND_SET_DISPATCH_FOR_OPERATION: Mapping[
    ...
    "checksum": _ReaderAndSetterForOperation.read_and_set_checksum,
    "kind": _ReaderAndSetterForOperation.read_and_set_kind,
...
_READ_AND_SET_DISPATCH_FOR_CAPABILITY: Mapping[
    ...
    "checksum": _ReaderAndSetterForCapability.read_and_set_checksum,
    "kind": _ReaderAndSetterForCapability.read_and_set_kind,
...
_READ_AND_SET_DISPATCH_FOR_CONCEPT_DESCRIPTION: Mapping[
    ...
    "checksum": _ReaderAndSetterForConceptDescription.read_and_set_checksum,
...
#: Dispatch XML property name to read & set method in
#: :py:class:`_ReaderAndSetterForLangString`
_READ_AND_SET_DISPATCH_FOR_LANG_STRING: Mapping[
    str,
    Callable[
        [_ReaderAndSetterForLangString, Element, Iterator[Tuple[str, Element]]], None
    ],
] = {
    "language": _ReaderAndSetterForLangString.read_and_set_language,
    "text": _ReaderAndSetterForLangString.read_and_set_text,
}
...
_DISPATCH_FOR_DATA_SPECIFICATION_CONTENT: Mapping[
    ...
    "dataSpecificationPhysicalUnit": _read_data_specification_physical_unit_as_sequence,
}
...
#: Dispatch XML property name to read & set method in
#: :py:class:`_ReaderAndSetterForDataSpecificationPhysicalUnit`
_READ_AND_SET_DISPATCH_FOR_DATA_SPECIFICATION_PHYSICAL_UNIT: Mapping[
    str,
    Callable[
        [
            _ReaderAndSetterForDataSpecificationPhysicalUnit,
            Element,
            Iterator[Tuple[str, Element]],
        ],
        None,
    ...
    "unitName": _ReaderAndSetterForDataSpecificationPhysicalUnit.read_and_set_unit_name,
    "unitSymbol": _ReaderAndSetterForDataSpecificationPhysicalUnit.read_and_set_unit_symbol,
    "definition": _ReaderAndSetterForDataSpecificationPhysicalUnit.read_and_set_definition,
    "siNotation": _ReaderAndSetterForDataSpecificationPhysicalUnit.read_and_set_si_notation,
    "siName": _ReaderAndSetterForDataSpecificationPhysicalUnit.read_and_set_si_name,
    "dinNotation": _ReaderAndSetterForDataSpecificationPhysicalUnit.read_and_set_din_notation,
    "eceName": _ReaderAndSetterForDataSpecificationPhysicalUnit.read_and_set_ece_name,
    "eceCode": _ReaderAndSetterForDataSpecificationPhysicalUnit.read_and_set_ece_code,
    "nistName": _ReaderAndSetterForDataSpecificationPhysicalUnit.read_and_set_nist_name,
    "sourceOfDefinition": _ReaderAndSetterForDataSpecificationPhysicalUnit.read_and_set_source_of_definition,
    "conversionFactor": _ReaderAndSetterForDataSpecificationPhysicalUnit.read_and_set_conversion_factor,
    "registrationAuthorityId": _ReaderAndSetterForDataSpecificationPhysicalUnit.read_and_set_registration_authority_id,
    "supplier": _ReaderAndSetterForDataSpecificationPhysicalUnit.read_and_set_supplier,
}
...
class _Serializer(aas_types.AbstractVisitor):
    ...
    def _write_extension_as_sequence(self, that: aas_types.Extension) -> None:
        ...
        if that.refers_to is not None:
            ...
            self._write_reference_as_sequence(that.refers_to)
    ...
    def _write_asset_administration_shell_as_sequence(
        ...
        if that.checksum is not None:
            self._write_str_property("checksum", that.checksum)
    ...
    def _write_asset_information_as_sequence(
        ...
        if that.global_asset_id is not None:
            self._write_start_element("globalAssetId")
            self._write_reference_as_sequence(that.global_asset_id)
            self._write_end_element("globalAssetId")
    ...
    def visit_submodel_element_collection(
        ...
        if (
            ...
            and that.checksum is None
            and that.kind is None
    ...
    def _write_entity_as_sequence(self, that: aas_types.Entity) -> None:
        ...
        if that.specific_asset_id is not None:
            self._write_start_element("specificAssetId")
            self._write_specific_asset_id_as_sequence(that.specific_asset_id)
            self._write_end_element("specificAssetId")
    ...
    def _write_event_payload_as_sequence(self, that: aas_types.EventPayload) -> None:
        ...
        if that.payload is not None:
            self._write_str_property("payload", that.payload)
    ...
    def _write_lang_string_as_sequence(self, that: aas_types.LangString) -> None:
        """
        Serialize :paramref:`that` to :py:attr:`~stream` as a sequence of
        XML elements.
    ...
    def visit_lang_string(self, that: aas_types.LangString) -> None:
        """
        Serialize :paramref:`that` to :py:attr:`~stream` as an XML element.
        ...
        :param that: instance to be serialized
        """
        self._write_start_element("langString")
        self._write_lang_string_as_sequence(that)
        self._write_end_element("langString")
    ...
    def _write_data_specification_iec_61360_as_sequence(
        ...
        if that.level_type is not None:
            self._write_str_property("levelType", that.level_type.value)
    ...
    def _write_data_specification_physical_unit_as_sequence(
        ...
        :param that: instance to be serialized
        """
        self._write_str_property("unitName", that.unit_name)

        self._write_str_property("unitSymbol", that.unit_symbol)

        if len(that.definition) == 0:
            self._write_empty_element("definition")
        else:
            self._write_start_element("definition")
            for an_item in that.definition:
                self.visit(an_item)
            self._write_end_element("definition")

        if that.si_notation is not None:
            self._write_str_property("siNotation", that.si_notation)

        if that.si_name is not None:
            self._write_str_property("siName", that.si_name)

        if that.din_notation is not None:
            self._write_str_property("dinNotation", that.din_notation)

        if that.ece_name is not None:
            self._write_str_property("eceName", that.ece_name)

        if that.ece_code is not None:
            self._write_str_property("eceCode", that.ece_code)

        if that.nist_name is not None:
            self._write_str_property("nistName", that.nist_name)

        if that.source_of_definition is not None:
            self._write_str_property("sourceOfDefinition", that.source_of_definition)

        if that.conversion_factor is not None:
            self._write_str_property("conversionFactor", that.conversion_factor)

        if that.registration_authority_id is not None:
            self._write_str_property(
                "registrationAuthorityId", that.registration_authority_id
            )

        if that.supplier is not None:
            self._write_str_property("supplier", that.supplier)
    ...
    def visit_data_specification_physical_unit(
        ...
        :param that: instance to be serialized
        """
        self._write_start_element("dataSpecificationPhysicalUnit")
        self._write_data_specification_physical_unit_as_sequence(that)
        self._write_end_element("dataSpecificationPhysicalUnit")
